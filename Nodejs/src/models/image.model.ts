...
class ImageMultipartUploadResponseTO implements ImageMultipartUploadResponseTOProps {
...
function convertImageMultipartUploadResponseTOJson(multipartJson: any) {
...
module.exports = {ImageMultipartUploadResponseTO, convertImageMultipartUploadResponseTOJson};
