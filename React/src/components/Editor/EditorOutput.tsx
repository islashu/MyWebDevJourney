...
Now imagine it is a blog postDataFromFeed with 1000 words and 10 images. It will take a lot of time to render the output.
 */
 ...
 * To take in data and display it as a postDataFromFeed
 * */
